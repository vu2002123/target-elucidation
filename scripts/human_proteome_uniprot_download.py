...
def output_list(id):
    ...
    BASE_URL = (
        f"https://www.ebi.ac.uk/interpro/api/entry/InterPro/protein/reviewed/{id}/?page_size=200"
    )
    next = BASE_URL
    last_page = False
    ...
    while next:
        ...
        for i, item in enumerate(payload["results"]):
            ...
            sys.stdout.write(
                parse_column(
                    item["proteins"][0]["entry_protein_locations"],
...
if __name__ == "__main__":
    ...
    file = DATA_DIR / "uniprot_ids_remain.txt"
