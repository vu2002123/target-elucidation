...
for drug in drugs:
    ...
    df_filtered = df_pubchem.query(
        "Activity == 'Active' and (Activity_Type == 'Ki' or Activity_Type == 'Kd') and (Activity_Qualifier == '<' or Activity_Qualifier == '=') and Activity_Value < @activity_threshold_um and Taxonomy_ID == 9606"
    )
