...
OUTPUT_FILE = INTERIM_DIR / "validation_sr.csv"
FIRST_TARGET_RANK_FILE = INTERIM_DIR / "first_target_rank_by_method.csv"
FIRST_TARGET_HEATMAP_FILE = FIG_DIR / "first_target_rank_heatmap.svg"
OVERALL_SUCCESS_HEATMAP_FILE = FIG_DIR / "overall_success_rate_heatmap.png"
CNN_VS_SUCCESS_FILE = INTERIM_DIR / "cnn_vs_success_rate_for_heatmap.csv"
CNN_VS_RECALL_FILE = INTERIM_DIR / "cnn_vs_recall_at_k_for_heatmap.csv"
TOTAL_TARGET_RECALL_HEATMAP_FILE = FIG_DIR / "cnn_vs_recall_total_targets_heatmap.png"
AVAILABLE_TARGET_RECALL_HEATMAP_FILE = FIG_DIR / "cnn_vs_recall_available_targets_heatmap.png"
...
SUCCESS_TOP_K_VALUES = (1, 10, 50, 100, 200, 500)
RANKING_METHODS = {
    "CNNaffinity": {
...
def read_dock_scores(
    ...
    # Exclude failed/non-binding poses in the same way as the original analysis.
