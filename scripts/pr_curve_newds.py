...
def load_scores_newds(drug_name, batch_name, weight: float):
    ...
    dock_score = (
        dock_score.sort_values(by="CNN_VS", ascending=False)
...
#     "Sunitinib",
# ]
drugs = ["Erlotinib", "Gefitinib", "Afatinib", "Crizotinib", "Ruxolitinib", "Sunitinib"]
...
for i, drug in enumerate(drugs):
    binder_file = f"/home/vu2002123/target-elucidation/data/raw/pubchem/{drug}_filtered_total.txt"
...
save_path = "/home/vu2002123/target-elucidation/reports/figures/TKI_drugs_auc_newds_rerun.png"
